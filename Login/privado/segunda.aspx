<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="segunda.aspx.cs" Inherits="Login.privado.segunda" %>
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="#sidenavAccordion">Seguimiento</a>
                                </nav>
                            </div>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Mi Tablero</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">General : Lista de Estudiantes</li>
                        </ol>
