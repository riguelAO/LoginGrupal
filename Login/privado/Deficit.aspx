        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">REGISTRO DE DEFICIT</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">En este apartado introduzca los datos del deficit que padece el estudiante</li>
                    </ol>
                        ...
                        <div class="card-header">
                            <form id="form2" runat="server">
                                <div>
                                    <p>
                                        CodDeficit:
                                                <asp:TextBox runat="server" Id="txtCodDeficit"  />
                                    </p>
                                    <p>
                                        tipoDeficit:
                                                <asp:TextBox runat="server" Id="txtTipoDeficit" />
                                    </p>
                                    <p>
                                        CodEstudiante:
                                    ...
                                    <p>
                                        <asp:Button Text="Agregar" runat="server" ID="Button1" OnClick="btnAgregar_Click" />
                                        <asp:Button Text="Eliminar" runat="server" ID="Button2" OnClick="btnEliminar_Click" />
                                        <asp:Button Text="Actualizar" runat="server" ID="Button3" OnClick="btnActualizar_Click" />
                                    </p>
                                    <p>
                                        <asp:GridView runat="server" ID="gvDeficit" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4">
