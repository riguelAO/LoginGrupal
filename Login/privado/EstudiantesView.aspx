<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EstudiantesView.aspx.cs" Inherits="Login.privado.EstudiantesView" %>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <!--estudiantes-->
                    <h1 class="mt-4">TABLAS DE INFORMACION
                    </h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">En este apartado se muestran los datos de las tablas existentes en la base de datos</li>
                    </ol>
                    <div class="card mb-4">
                        <div class="card-header">
                            <form id="form1" runat="server">
                                ...
                                <div>
                                    <p>
                                        <asp:GridView runat="server" ID="gvCursos" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4">
                                            <FooterStyle BackColor="#FFFFCC" ForeColor="#330099" />
                                            <HeaderStyle BackColor="#990000" Font-Bold="True" ForeColor="#FFFFCC" />
                                            <PagerStyle BackColor="#FFFFCC" ForeColor="#330099" HorizontalAlign="Center" />
                                            <RowStyle BackColor="White" ForeColor="#330099" />
                                ...
                                <h1> Tabla de grados</h1>
                                <div>
                                    <p>
                                        <asp:GridView runat="server" ID="gvGrados" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4">
                                            <FooterStyle BackColor="#FFFFCC" ForeColor="#330099" />
                                            <HeaderStyle BackColor="#990000" Font-Bold="True" ForeColor="#FFFFCC" />
                                            <PagerStyle BackColor="#FFFFCC" ForeColor="#330099" HorizontalAlign="Center" />
                                            <RowStyle BackColor="White" ForeColor="#330099" />
