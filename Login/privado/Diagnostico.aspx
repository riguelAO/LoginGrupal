        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">REGISTRO DE DIAGNOSTICO</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">En este apartado introduzca sus datos del diagnostico    </li>
                    </ol>
                        ...
                        <div class="card-header">
                            <form id="form2" runat="server">
                                <div>
                                    <p>
                                        CodDiagnostico:
                                                <asp:TextBox runat="server" Id="txtCodDiagnostico"  />
                                    </p>
                                    <p>
                                        tipoDiagnostico:
                                                <asp:TextBox runat="server" Id="txtTipoDiagnostico" />
                                    </p>
                                    <p>
                                        codDeficit:
                                                <asp:TextBox runat="server" Id="txtCodDeficit1" />
                                    </p>
                                    <p>
                                    ...
                                    <p>
                                        <asp:GridView runat="server" ID="gvDiagnostico" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4">
