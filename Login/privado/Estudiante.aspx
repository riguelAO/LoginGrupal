                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="#charts" data-bs-target="#charts">
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">REGISTRO DE ESTUDIANTES</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">En este apartado introduzca los datos del estudiante</li>
                    </ol>
                                    ...
                                    <div>
                                        <p>
                                            ...
                                            <asp:DropDownList ID="ddlCriterio" runat="server" OnSelectedIndexChanged="ddlCriterio_SelectedIndexChanged">
                                                ...
                                                <asp:ListItem Text="CodEstudiante" />
                                                <asp:ListItem Text="Grado" />
                                                ...
                                                <asp:ListItem Text="codCurso" />
                                                <asp:ListItem Text="codGrado" />
                                            </asp:DropDownList>
                                        ...
                                        <p>
                                            CodEstudiante :
                                            <asp:TextBox runat="server" ID="txtCodEstudiante" />
                                        </p>
                                        <p>
                                            Grado :
                                            <asp:TextBox runat="server" ID="txtGrado" />
                                        </p>
                                        <p>
                                            Apellidos :
                                        ...
                                        <p>
                                            Nombres:
                                            <asp:TextBox runat="server" ID="txtNombres" />
                                        </p>
                                        <p>
                                            DNI:
                                        ...
                                        <p>
                                            Fecha de nacimiento:
                                            <asp:TextBox runat="server" ID="txtFech" />
                                        </p>
                                        <p>
                                            Direccion :
                                            <asp:TextBox runat="server" ID="txtDireccion" Width="389px" />
                                        </p>
                                        <p>
                                            Genero :
                                            <asp:TextBox runat="server" ID="txtGenero" />
                                        </p>
                                        <p>
                                            codInstitucion :
                                            <asp:TextBox runat="server" ID="txtcodInstitucion" />
                                        </p>
                                        <p>
                                            codCurso :
                                            <asp:TextBox runat="server" ID="txtcodCurso" />
                                        </p>
                                        <p>
                                            codGrado :
                                            <asp:TextBox runat="server" ID="txtcodGrado" />
                                        </p>
                                        <p>
                                        ...
                                        <p>
                                            <asp:GridView runat="server" ID="gvEstudiante" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4">
